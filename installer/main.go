...
func (d *daemon) downloadAgent() (err error) {
...
func (d *daemon) installAgent() (err error) {
	err = d.daemon.Install()
	if checkError(err) {
...
func (d *daemon) checkForUpdates() (err error) {
...
func (d *daemon) uninstallAgent() (err error) {
